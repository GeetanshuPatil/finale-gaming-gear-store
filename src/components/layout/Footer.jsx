        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-md text-sm leading-6 text-gray-400">
              ...
              peripherals, accessories, and everything you need to level up your
              gaming experience.
            </p>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <a
                href="https://linkedin.com/in/geetanshu-patil-923637375/"
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-full
  bg-gray-800 text-gray-400 hover:bg-blue-600 hover:text-white
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-gray-500">
            ...
            <p>
              Built by{" "}
              <span className="text-gray-400 font-medium">Geetanshu Patil</span>
            </p>
          </div>
        </div>
      </div>
